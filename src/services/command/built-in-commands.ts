...
const BUILT_IN_COMMANDS: Record<string, BuiltInCommandDefinition> = {
	// kilocode_change start - Modified all .roo references to .schmidtaicoder for Schmidt AI Coder fork
	init: {
		name: "init",
  ...
  <todo_list_creation>
    If the update_todo_list tool is available, create a todo list with these focused analysis steps:
     ...
     1. Check for existing AGENTS.md files
       ...
       - .schmidtaicoder/rules-code/AGENTS.md (relative to project root)
       - .schmidtaicoder/rules-debug/AGENTS.md (relative to project root)
       - .schmidtaicoder/rules-ask/AGENTS.md (relative to project root)
       - .schmidtaicoder/rules-architect/AGENTS.md (relative to project root)
    ...
    8. Compile/Update AGENTS.md files
       - If files exist: AGGRESSIVELY clean them up
        ...
        - Create mode-specific files in .schmidtaicoder/rules-*/ directories (IN PROJECT ROOT)
...
<analysis_workflow>
  ...
  1. **Discovery Phase**:
     ...
     IMPORTANT: The .schmidtaicoder folder should be created in the PROJECT ROOT, not system root!
...
<output_structure>
  ...
  <mode_specific_files>
    ...
    - .schmidtaicoder/rules-code/AGENTS.md (create .schmidtaicoder in project root, not system root!)
    - .schmidtaicoder/rules-debug/AGENTS.md (relative to project root)
    - .schmidtaicoder/rules-ask/AGENTS.md (relative to project root)
    - .schmidtaicoder/rules-architect/AGENTS.md (relative to project root)
    
    IMPORTANT: The .schmidtaicoder directory must be created in the current project/workspace root directory,
    ...
    ├── .schmidtaicoder/                   # IN PROJECT ROOT, NOT SYSTEM ROOT!
    │   ├── rules-code/
    ...
    .schmidtaicoder/rules-code/AGENTS.md - ONLY non-obvious coding rules discovered by reading files:
    ...
    .schmidtaicoder/rules-debug/AGENTS.md - ONLY non-obvious debugging discoveries:
    ...
    .schmidtaicoder/rules-ask/AGENTS.md - ONLY non-obvious documentation context:
    ...
    .schmidtaicoder/rules-architect/AGENTS.md - ONLY non-obvious architectural constraints:
