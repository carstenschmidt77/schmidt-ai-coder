...
export function isModelNotAllowedForTeamError(error: any) {
	//https://github.com/schmidt-embedded-systems/schmidt-ai-coder-backend/blob/66489e1b0f6f996338acf8bcc1b3558252e20e9d/src/app/api/openrouter/%5B...path%5D/route.ts#L371
