...
export async function run() {
	...
	const extension = vscode.extensions.getExtension<RooCodeAPI>("schmidt-embedded-systems.Schmidt-AI-Coder")
	...
	/**
	 * Wait for the Schmidt AI Coder to be ready to accept tasks.
	 */

	await waitUntilReady({ api })

	/**
	 * Configure Schmidt AI Coder as needed.
	 *
	...
	await vscode.workspace
		.getConfiguration("schmidt-ai-coder")
