...
export const SettingsFooter = ({ version, className, ...props }: SettingsFooterProps) => (
	<div className={cn("text-vscode-descriptionForeground p-5", className)} {...props}>
		<p style={{ wordWrap: "break-word", margin: 0, padding: 0 }}>
			...
			<VSCodeLink href="https://github.com/schmidt-embedded-systems/schmidt-ai-coder" style={{ display: "inline" }}>
				github.com/schmidt-embedded-systems/schmidt-ai-coder
			</VSCodeLink>{" "}
			or join{" "}
		...
		<p style={{ wordWrap: "break-word", margin: 0, padding: 0 }}>
			...
			<VSCodeLink href="mail:hi@schmidt-embedded-systems.de/ai" style={{ display: "inline" }}>
				hi@schmidt-embedded-systems.de/ai
			</VSCodeLink>{" "}
		</p>
		<p className="italic">Schmidt AI Coder v{version}</p>
