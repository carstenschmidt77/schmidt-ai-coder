 ...
 * contextManager.setContext("schmidtaicoder.autocomplete.enableQuickInlineTaskKeybinding", true)
 * val value = contextManager.getContext("schmidtaicoder.autocomplete.enableQuickInlineTaskKeybinding")
 * ```
 */
...
class ContextManager {
     ...
     * 
     * @param key The context key (e.g., "schmidtaicoder.autocomplete.enableQuickInlineTaskKeybinding")
