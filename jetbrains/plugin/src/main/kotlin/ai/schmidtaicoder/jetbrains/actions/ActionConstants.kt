...
object CommandIds {
    ...
    const val EXPLAIN = "schmidt-ai-coder.explainCode"

    /** Command ID for fixing code */
    const val FIX = "schmidt-ai-coder.fixCode"

    /** Command ID for improving code */
    const val IMPROVE = "schmidt-ai-coder.improveCode"

    /** Command ID for adding to context */
    const val ADD_TO_CONTEXT = "schmidt-ai-coder.addToContext"

    /** Command ID for creating a new task */
    const val NEW_TASK = "schmidt-ai-coder.newTask"
}
